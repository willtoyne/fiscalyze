"""
FISCALYZE - Financial Forecasting Web App
=========================================

A Streamlit-based financial forecasting web app for small businesses.
This is an all-in-one script that contains all components of the app.

To run this app:
1. Install required packages:
   pip install streamlit pandas numpy scikit-learn matplotlib plotly reportlab sqlalchemy psycopg2-binary

2. Run the app:
   streamlit run fiscalyze_all_in_one.py

For database setup, you'll need to set the following environment variables:
- DATABASE_URL: PostgreSQL connection URL
(or you can modify the database connection to use a local SQLite database)
"""
